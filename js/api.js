...
const YARO_API = (function() {
  ...
  var FALLBACK_PRODUCTS = [
    ...
    { id: 'mini-logo-tee', slug: 'mini-logo-tee', name: 'Late Escape', category: 'Midnight Society', price: '₹899', originalPrice: '₹1299', original_price: 1299, offerName: 'Clearance', badge: 'New', badgeClass: 'new', image: 'images/mini_logo_tee.png', images: ['images/mini_logo_tee.png'], story: 'Sneaking out into the cool night, leaving the city behind.', desc: 'Classic kids white graphic t-shirt in extremely soft organic ring-spun combed cotton, featuring the YARO micro logo on the chest.', sizes: ['XS','S','M','L'], additionalImages: [] },
    { id: 'mini-hoodie', slug: 'mini-hoodie', name: 'Lost Path', category: 'Wander', price: '₹899', originalPrice: '₹1399', original_price: 1399, offerName: 'Clearance', badge: 'New', badgeClass: 'new', image: 'images/mini_hoodie.png', images: ['images/mini_hoodie.png'], story: 'Not all who wander are looking for a way home.', desc: 'Ultra soft double fleece organic light beige kid hoodie. Minimalist clean style with micro branding and perfect warmth for children.', sizes: ['XS','S','M','L'], additionalImages: [] }
  ];
